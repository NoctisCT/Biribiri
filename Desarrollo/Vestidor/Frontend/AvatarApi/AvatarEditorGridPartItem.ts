...
export class AvatarEditorGridPartItem implements IAvatarImageListener
{
    ...
    public init(): void
    {
        ...
        {
            // Al reabrir el editor algunos assets pueden haber terminado
            // de cargar después del primer intento. Reintentamos el render
            // en vez de dejar el thumbnail vacío hasta cambiar un color.
            this.update();
