...
import com.retro.builderpro.handlers.MirrorDuplicateRequest;
        ...
        implements EventListener
{
            ...
            throws Exception
    {
        ...
        Emulator.getGameServer()
                .getPacketManager()
                .registerHandler(
                        BuilderProPackets.MIRROR_DUPLICATE_REQUEST,
                        MirrorDuplicateRequest.class
                );

        Emulator.getGameServer()
                .getPacketManager()
                .registerHandler(
                        BuilderProPackets.REPLACE_GROUP_REQUEST,
                        ReplaceGroupRequest.class
                );

        Emulator.getGameServer()
                .getPacketManager()
                .registerHandler(
                        BuilderProPackets.LINEAR_REPEAT_REQUEST,
                        LinearRepeatRequest.class
                );
        ...
        Emulator.getGameServer()
                .getPacketManager()
                .registerHandler(
                        BuilderProPackets.FILL_REPEAT_REQUEST,
