                        ...
                        <Column gap={ 1 } position={ !isTrading ? 'absolute' : 'relative' } className="bottom-1" style={ { width: !isTrading ? '39%' : '' } }>
                            ...
                            { (isTrading) &&
                                <Column gap={ 1 } alignItems="start">
                                    ...
                                    <Button variant="secondary" disabled={ !quantity || selectedItem.getUnlockedCount() === 0 } onClick={ event => !quantity ? null : changeCount(selectedItem.getUnlockedCount()) }>{ LocalizeText('inventory.trading.offer.button') }</Button>
                                </Column>
                            }
