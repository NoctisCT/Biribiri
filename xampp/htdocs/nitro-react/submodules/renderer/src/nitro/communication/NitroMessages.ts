...
import { ReactionProfileEvent } from './messages/incoming/reactions';
import { AvatarReactionEvent } from './messages/incoming/reactions';
import { CoinResponseComposer, CoinTossComposer, DuelChallengeComposer, DuelChoiceComposer, DuelResponseComposer, FollowUserComposer } from './messages/outgoing/interactions';
import { GetReactionProfileComposer, SaveReactionDisplayModeComposer, SaveReactionSlotsComposer } from './messages/outgoing/reactions';
...
import { PartyInviteEvent, PartyRallyEvent, PartyStateEvent } from './messages/incoming/interactions';
import { PartyActionComposer, PartyChatComposer, PartyInviteComposer, PartyInviteResponseComposer, PartyVisitComposer } from './messages/outgoing/interactions';
...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        ...
        this._events.set(IncomingHeader.BUILDER_PRO_BLUEPRINT_STATE_RESULT, BuilderProBlueprintStateEvent);
        this._events.set(IncomingHeader.BUILDER_PRO_PICKUP_GROUP_RESULT, BuilderProPickupGroupResultEvent);
        this._events.set(IncomingHeader.BUILDER_PRO_LAYER_STATE_RESULT, BuilderProLayerStateEvent);
        this._events.set(IncomingHeader.BUILDER_PRO_MIRROR_DUPLICATE_RESULT, BuilderProMirrorDuplicateResultEvent);
        this._events.set(IncomingHeader.BUILDER_PRO_REPLACE_GROUP_RESULT, BuilderProReplaceGroupResultEvent);
        ...
        // AVAILABILITY
        this._events.set(IncomingHeader.AVATAR_REACTION, AvatarReactionEvent);
        this._events.set(IncomingHeader.REACTION_PROFILE, ReactionProfileEvent);
        this._events.set(IncomingHeader.DUEL_INVITE, DuelInviteEvent);
        this._events.set(IncomingHeader.DUEL_STATE, DuelStateEvent);
        this._events.set(IncomingHeader.DUEL_RESULT, DuelResultEvent);
        this._events.set(IncomingHeader.DUEL_PUBLIC, DuelPublicEvent);
        this._events.set(IncomingHeader.FOLLOW_STATE, FollowStateEvent);
        this._events.set(IncomingHeader.COIN_RESULT, CoinTossEvent);
        this._events.set(IncomingHeader.PARTY_INVITE_EVENT, PartyInviteEvent);
        this._events.set(IncomingHeader.PARTY_STATE, PartyStateEvent);
        this._events.set(IncomingHeader.PARTY_RALLY, PartyRallyEvent);
 ...
 this._events.set(IncomingHeader.ESTADO_SUBASTA, EstadoSubastaEvent);
    ...
    private registerComposers(): void {
        ...
        this._composers.set(OutgoingHeader.BUILDER_PRO_MIRROR_DUPLICATE, BuilderProMirrorDuplicateComposer);
        this._composers.set(OutgoingHeader.BUILDER_PRO_REPLACE_GROUP, BuilderProReplaceGroupComposer);
        ...
        this._composers.set(OutgoingHeader.BUILDER_PRO_ITEM_LOCK_STATE, BuilderProItemLockStateComposer);
        ...
        this._composers.set(OutgoingHeader.AVATAR_REACTION, AvatarReactionComposer);
        this._composers.set(OutgoingHeader.GET_REACTION_PROFILE, GetReactionProfileComposer);
        this._composers.set(OutgoingHeader.SAVE_REACTION_SLOTS, SaveReactionSlotsComposer);
        this._composers.set(OutgoingHeader.SAVE_REACTION_DISPLAY_MODE, SaveReactionDisplayModeComposer);
        this._composers.set(OutgoingHeader.DUEL_CHALLENGE, DuelChallengeComposer);
        this._composers.set(OutgoingHeader.DUEL_RESPONSE, DuelResponseComposer);
        this._composers.set(OutgoingHeader.DUEL_CHOICE, DuelChoiceComposer);
        this._composers.set(OutgoingHeader.FOLLOW_TOGGLE, FollowUserComposer);
        this._composers.set(OutgoingHeader.COIN_TOSS, CoinTossComposer);
        this._composers.set(OutgoingHeader.COIN_RESPONSE, CoinResponseComposer);
        this._composers.set(OutgoingHeader.PARTY_INVITE, PartyInviteComposer);
        this._composers.set(OutgoingHeader.PARTY_INVITE_RESPONSE, PartyInviteResponseComposer);
        this._composers.set(OutgoingHeader.PARTY_ACTION, PartyActionComposer);
        this._composers.set(OutgoingHeader.PARTY_CHAT, PartyChatComposer);
        this._composers.set(OutgoingHeader.PARTY_VISIT, PartyVisitComposer);
