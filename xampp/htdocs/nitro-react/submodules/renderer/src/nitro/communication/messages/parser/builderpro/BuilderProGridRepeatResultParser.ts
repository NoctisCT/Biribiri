...
export type BuilderProGridRepeatPreviewEntry = {
    baseItemId: number;
    x: number;
    y: number;
    z: number;
...
export class BuilderProGridRepeatResultParser implements IMessageParser
{
    ...
    private _previewEntries: BuilderProGridRepeatPreviewEntry[] = [];
    ...
    public parse(wrapper: IMessageDataWrapper): boolean
    {
        ...
        this._columns = wrapper.readInt();
        this._rows = wrapper.readInt();
    ...
    public get previewEntries(): BuilderProGridRepeatPreviewEntry[]
    {
