...
export type BuilderProRadialRepeatPreviewEntry = {
    baseItemId: number;
    x: number;
    y: number;
    z: number;
...
export class BuilderProRadialRepeatResultParser implements IMessageParser
{
    ...
    private _radius = 0;
    private _rotateWithPattern = false;
    private _pivotId = 0;
    private _placedCount = 0;
    private _previewEntries: BuilderProRadialRepeatPreviewEntry[] = [];
    ...
    public parse(wrapper: IMessageDataWrapper): boolean
    {
        ...
        this._totalAngle = wrapper.readInt();
        this._radius = wrapper.readInt();
        this._rotateWithPattern = wrapper.readBoolean();
        this._pivotId = wrapper.readInt();
    ...
    public get totalAngle(): number { return this._totalAngle; }
    public get radius(): number { return this._radius; }
    public get rotateWithPattern(): boolean { return this._rotateWithPattern; }
    public get pivotId(): number { return this._pivotId; }
    public get placedCount(): number { return this._placedCount; }

    public get previewEntries(): BuilderProRadialRepeatPreviewEntry[]
    {
