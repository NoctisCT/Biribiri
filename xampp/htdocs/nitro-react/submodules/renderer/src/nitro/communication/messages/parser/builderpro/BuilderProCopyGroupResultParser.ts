...
export type BuilderProCopyPreviewEntry = {
    baseItemId: number;
    offsetX: number;
    offsetY: number;
    offsetZ: number;
...
export class BuilderProCopyGroupResultParser implements IMessageParser
{
    ...
    private _code = 0;
    private _message = '';
    private _copiedCount = 0;
    private _sourceAnchorZ = 0;
    private _previewEntries: BuilderProCopyPreviewEntry[] = [];
    ...
    public parse(wrapper: IMessageDataWrapper): boolean
    {
        ...
        this._copiedCount = wrapper.readInt();
    ...
    public get copiedCount(): number { return this._copiedCount; }
    public get sourceAnchorZ(): number { return this._sourceAnchorZ; }
    public get previewEntries(): BuilderProCopyPreviewEntry[]
    {
        return this._previewEntries.map(entry => ({ ...entry }));
    }
}
